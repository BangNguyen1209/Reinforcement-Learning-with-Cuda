from lux.game.match_controller import ActionSequence
import sys
import time
...
from lux.game.game_constants import GAME_CONSTANTS
from lux.game.position import Position
...
########################################################################################################################
class AgentPersonalCustom(Agent):
    ...
    def get_reward(self, game, is_game_finished, is_new_turn, is_game_error):
        ...
        # Print the final game stats sometimes => DEBUG
